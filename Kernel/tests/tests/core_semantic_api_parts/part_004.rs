...
#[test]
fn cov2_configuration_domain_and_features_catalogs_are_closed() {
    ...
    let decision_classes = [
        features_core::FeatureAdmissionDecisionClass::Rejected,
        features_core::FeatureAdmissionDecisionClass::SupportedBySourceContract,
    ];
    assert_eq!(decision_classes.len(), 2);
    ...
    let feature_failures = [
        ...
        (
            features_core::FeatureAdmissionFailureKind::FeatureNotSupported,
...
#[test]
fn cov2_state_identity_security_and_time_boundaries_cover_closed_shapes() {
    ...
    let prohibited_state_behaviors = [
        ...
        state_core::ProhibitedStatePersistenceBehavior::CheckpointRestoreWithoutRestorePolicy,
    ...
    let untrusted = UntrustedReference::new("untrusted-reference-core-api");
    assert_eq!(untrusted.as_str(), "untrusted-reference-core-api");
    ...
    assert_eq!(accepted.as_str(), "untrusted-reference-core-api");
    assert_eq!(
        accepted.authority(),
        ReferenceAuthority::CoreValidatedUntrustedInput
    );
    ...
    for (quantity, unit) in [
        ...
        (
            ...
            time_core::NormalizedUnit::UtcEpochMillisecondsObservationOnly,
        ),
        (
    ...
    let unit_statuses = [
        time_core::MeasurementUnitWindowStatus::RawAndNormalizedAvailable,
        time_core::MeasurementUnitWindowStatus::NormalizedValueAvailable,
        time_core::MeasurementUnitWindowStatus::MissingUnitOrWindow,
    ];
    assert_eq!(unit_statuses.len(), 3);
    ...
    let policy = time_core::ClockSkewPolicy::try_new(
        ...
        time_core::TrustedTimeSourceClass::ExternalTimeSourceObservation,
        time_core::ClockSkewImpact::Verification,
    )
...
#[test]
fn cov2_transport_boundary_variants_and_failure_codes_are_closed() {
    ...
    let observation_meanings = [
        transport_core::IceObservationMeaning::DiagnosticObservationOnly,
    ...
    let secure_verification = [
        transport_core::SecureMediaVerificationClass::Handshake,
        transport_core::SecureMediaVerificationClass::PeerVerification,
        transport_core::SecureMediaVerificationClass::ProtectionState,
        transport_core::SecureMediaVerificationClass::PacketForwardingScope,
    ];
    assert_eq!(secure_verification.len(), 4);

...
#[test]
fn cov3_reason_audit_and_cross_plane_catalogs_are_asserted() {
...
#[test]
fn cov3_command_protocol_and_runtime_catalogs_are_asserted() {
    ...
    assert_eq!(event.correlation_id().as_str(), "corr-core-api");
    ...
    assert_eq!(trace.correlation_id().as_str(), "corr-core-api");
    assert_eq!(
    ...
    assert_eq!(prior.prior_correlation_id().as_str(), "corr-core-api");
    ...
    let rule_set = protocol_core::CanonicalEncodingRuleSet::new(
        protocol_core::CanonicalRuleStatus::Specified,
        protocol_core::CanonicalRuleStatus::Specified,
        protocol_core::CanonicalRuleStatus::Specified,
        protocol_core::CanonicalRuleStatus::Specified,
        protocol_core::CanonicalRuleStatus::Specified,
    ...
    assert!(rule_set.is_complete_for_canonical_encoding());
    ...
    let deprecation = protocol_core::DeprecationDecision::new(
        ...
        vec![
            ...
            protocol_core::DeprecationLifecycleStep::RemoveAfterCompatibilityWindow,
        ],
    );
...
#[test]
fn cov3_signaling_sfu_and_turn_state_tables_are_asserted() {

...
#[test]
fn workspace_membership_matches_declared_v0_2_layer_surface() {
...
#[test]
fn required_directories_are_not_replaced_by_docs_or_generated_targets() {
...
#[test]
fn semantic_modular_monolith_keeps_line_count_as_review_signal() {
...
#[test]
fn semantic_modular_monolith_rejects_source_shape_collapse() {
    let root = implementation_root();
...
#[test]
fn production_sources_do_not_hide_local_too_many_arguments_suppression() {
...
#[test]
fn production_manifests_do_not_depend_on_test_or_integration_crates() {
    for manifest in files_named(&implementation_root(), "Cargo.toml") {
        ...
        assert_not_contains(
            ...
            &content,
            &[
                "arcrtc-kernel-test-suite",
                "arcrtc-kernel-integration-test-suite",
                "../tests",
                "../integration-tests",
            ],
        );
...
#[test]
fn core_source_shape_rejects_concrete_runtime_io_and_feature_inversion() {
    let root = implementation_root();
...
#[test]
fn v01_material_is_not_v0_2_source_authority() {
    for manifest in files_named(&implementation_root(), "Cargo.toml") {
        let relative = impl_relative(&manifest);

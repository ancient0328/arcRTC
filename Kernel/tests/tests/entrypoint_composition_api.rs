...
use arcrtc_entrypoint_configuration::{
    ...
    ConfigurationProfileClass, RuntimeConfigurationGenerationState,
...
#[test]
fn configuration_bundle_validation_is_fail_closed_and_profile_scoped() {
    assert_eq!(
...
#[test]
fn public_endpoint_declaration_rejects_protocol_target_and_scope_drift() {
    assert_eq!(
...
#[test]
fn readiness_and_internal_control_do_not_collapse_to_boolean_success() {
    assert_eq!(
...
#[test]
fn server_composition_sources_remain_core_driver_wiring_only() {
    for path in [
...
#[test]
fn runtime_reconfiguration_requires_generation_scope_and_admitted_class() {
    assert_eq!(
...
#[test]
fn edge_proxy_service_discovery_and_internal_trust_do_not_fail_open() {
    assert_eq!(
...
#[test]
fn operator_admin_authorization_rejects_missing_scope_and_domain_reuse() {
    assert_eq!(

...
pub fn build_product_live_profile(
    ...
    if admission.implementation_reason != ImplementationEvidenceReason::ImplementationOk {
    ...
    Ok(ProductRuntimeProfile {
        ...
        environment_class:
            arcrtc_implementation_evidence::ImplementationEnvironmentClass::LiveDeferred,

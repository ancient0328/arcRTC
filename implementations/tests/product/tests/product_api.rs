...
fn product_plane_accepts_only_three_reference_output_inputs() {
    for (path, allowed) in [
        (
            "product-implementation/signaling/src/kernel_contract.rs",
            "ReferenceSignalingOutcome",
        ),
        (
            "product-implementation/turn/src/kernel_contract.rs",
            "ReferenceTurnOutcome",
        ),
        (
            "product-implementation/sfu/src/kernel_contract.rs",
            "ReferenceSfuOutcome",
        ),
    ] {
        let source =
...
fn kpi_product_api_executes_allowed_reference_output_inputs() {
    ...
    assert_eq!(
        signaling_result.implementation_reason,
        ImplementationEvidenceReason::ImplementationOk
    );
    ...
    assert_eq!(
        sfu_result.implementation_reason,
        ImplementationEvidenceReason::ImplementationOk
    );
    assert!(sfu_result
        .non_claim_scope

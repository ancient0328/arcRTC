...
fn explicit_test_package_manifests_match_canonical_package_names() {
    for (path, name) in [
        (
            ...
            "arcrtc-implementation-boundary-tests",
        ),
        (
            "tests/reference/Cargo.toml",
            "arcrtc-implementation-reference-tests",
        ),
        (
            "tests/product/Cargo.toml",
            "arcrtc-implementation-product-tests",
        ),
        (
        ...
        (
            ...
            "arcrtc-implementation-production-readiness-tests",
        ),
        ("tests/live/Cargo.toml", "arcrtc-implementation-live-tests"),
    ] {
        let body = read(path);

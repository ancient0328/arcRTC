...
fn kpi_reference_composition_executes_cross_plane_binding() {
    ...
    assert_eq!(signaling.applied_plane, ImplementationPlane::Signaling);
    assert!(matches!(
    ...
    assert_eq!(turn.applied_plane, ImplementationPlane::Turn);
    assert!(matches!(
        turn.plane_outcome,
    ...
    assert_eq!(sfu_admission.applied_plane, ImplementationPlane::Sfu);
    assert!(matches!(
    ...
    assert_eq!(turn_binding.applied_plane, ImplementationPlane::Composition);
    assert_eq!(
    ...
    assert_eq!(sfu_binding.applied_plane, ImplementationPlane::Composition);
...
fn composition_binds_only_existing_cross_plane_state() {
    ...
    .expect("signaling to turn binding must succeed");
    assert_eq!(
        turn_outcome.implementation_reason,

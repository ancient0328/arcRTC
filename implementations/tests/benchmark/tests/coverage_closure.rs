...
use arcrtc_product_deployment::{
    build_product_runtime_profile, runtime::ImplementationRuntimeState as ProductRuntimeState,
...
use arcrtc_reference_ops::{
    build_reference_build_evidence_record, write_implementation_evidence_record,
    ImplementationRuntimeState as ReferenceRuntimeState, ImplementationShutdownMode,
...
fn benchmark_evidence_record_validation_rejects_projection_mutations_after_build() {
    ...
    missing_threshold_non_claim
        .base
        .non_claim_scope
        .retain(|scope| scope != &ImplementationNonClaimScope::BenchmarkThresholdNotClaimed);
    assert_eq!(
    ...
    layer_mismatch.base.implementation_layer = ImplementationLayer::Product;
    assert_eq!(
    ...
    plane_mismatch.base.target_plane = ImplementationPlane::Turn;
    assert_eq!(
...
fn benchmark_reference_ops_runtime_and_evidence_cover_fail_closed_branches() {
    ...
    let build_write = write_implementation_evidence_record(&build)
    ...
    non_reference_writer.implementation_layer = ImplementationLayer::Product;
    assert_eq!(
        write_implementation_evidence_record(&non_reference_writer),
    ...
    assert_eq!(
        write_implementation_evidence_record(&unsafe_dot),
        Err(ReferenceRuntimeError::CommandScopeMismatch)
    );
    ...
    assert_eq!(
        write_implementation_evidence_record(&unsafe_path),
        Err(ReferenceRuntimeError::CommandScopeMismatch)
    );

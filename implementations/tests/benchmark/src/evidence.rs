...
pub fn validate_benchmark_evidence_record(
    ...
    if record.base.command_class != ImplementationCommandClass::Benchmark {
    ...
    if record.layer != record.base.implementation_layer || record.layer != scenario.layer {
    ...
    if record.criterion_group != "implementation_benchmark_scenarios" {

...
use arcrtc_implementation_benchmark_tests::{execute_kpi_actual_workload, BENCHMARK_SCENARIOS};
use criterion::{black_box, criterion_group, criterion_main, Criterion};

fn bench_all_scenarios(criterion: &mut Criterion) {
    let mut group = criterion.benchmark_group("implementation_benchmark_scenarios");

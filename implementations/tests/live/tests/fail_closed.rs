...
fn production_record_in_live_file(gate_id: &str) -> ReadinessEvidenceRecord {
    ...
    record.base.command_class = ImplementationCommandClass::ProductionReadiness;
...
fn live_readiness_rejects_command_claim_mismatch_and_empty_required_refs() {
    ...
    wrong_command_class.base.command_class = ImplementationCommandClass::ProductionReadiness;
    wrong_command_class
        .base
        .non_claim_scope
        .push(ImplementationNonClaimScope::LiveReadinessNotClaimed);
    assert_eq!(

...
use crate::{
    record::{DistroCommandClass, DistroEvidenceRecord},
...
fn validate_claim_and_command_class(
    ...
    match (record.readiness_claim, record.base.command_class) {
        (ReadinessClaim::ProductionReadiness, DistroCommandClass::ProductionReadiness)
        | (ReadinessClaim::LiveReadiness, DistroCommandClass::LiveReadiness) => Ok(()),

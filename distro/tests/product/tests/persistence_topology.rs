...
fn kpi_product_persistence_executes_without_kernel_state_ownership() {
    for path in [
        "product-distro/persistence-topology/src/topology.rs",
        "product-distro/persistence-topology/src/mapper.rs",
    ] {

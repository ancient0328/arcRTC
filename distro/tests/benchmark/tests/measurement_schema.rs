...
use arcrtc_distro_evidence::{
    EvidenceValidationError, DistroCommandClass, DistroEnvironmentClass,
...
fn benchmark_measurement_schema_rejects_invalid_scope_and_values() {
    ...
    wrong_command_class.command_class = DistroCommandClass::Test;
    assert_eq!(
...
fn benchmark_record_validation_rejects_mutated_scenario_projection_fields() {
    ...
    record.layer = DistroLayer::Product;
    assert_eq!(

...
fn base() -> DistroEvidenceRecord {
    DistroEvidenceRecord {
        ...
        command_class: DistroCommandClass::ProductionReadiness,
...
fn live_record_in_production_file(gate_id: &str) -> ReadinessEvidenceRecord {
    ...
    record.base.command_class = DistroCommandClass::LiveReadiness;
...
fn production_readiness_rejects_command_claim_mismatch_and_empty_required_refs() {
    ...
    wrong_command_class.base.command_class = DistroCommandClass::LiveReadiness;
    assert_eq!(

# arcRTC v0.2 distro — Benchmark Results
...
Each row is the workload exercised inside the timed closure. "reference" scenarios run the reference SFU / TURN / Signaling distro on the frozen Kernel contract; "product" scenarios run the product-side decision functions.
